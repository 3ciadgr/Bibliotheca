 ...
 * @author Relox
 */
public class Register_Librarian extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("REGISTER A LIBRARIAN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            int exist = 0;
            String sql2 = "select * from librarian where Username=?";
            ...
            if(exist == 1) {
                ...
                String sql = "Insert into librarian (Username, Name, PhoneNumber, Password, code) values (?, ?, ?, ?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_Librarian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_Librarian().setVisible(true);
            }
        });
    }
