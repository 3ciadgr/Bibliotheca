...
PreparedStatement pst;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(!name.equals("") && !phonenumber.equals("") && !password.equals("") && !user.equals("")) {
                String query = "update admin set name = ?, phonenumber = ?, password = ? where username = ?";
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try {
            ...
            String sql = "select * from admin where username = '"+combobox+"'";
            ...
            JOptionPane.showMessageDialog(null,"Failed tro Connect to Database","Error Connection", JOptionPane.WARNING_MESSAGE);  
            System.exit(0);  
        }
