...
package Admin;
public class ChooseRegister_Admin extends javax.swing.JFrame {
    public ChooseRegister_Admin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ADD AN ACCOUNT");
        ...
        setSize(new java.awt.Dimension(751, 537));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        setVisible(false);
        Register_Borrower ob = new Register_Borrower();
        ob.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        setVisible(false);
        Register_Librarian ob = new Register_Librarian();
        ob.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        setVisible(false);
        Register_Admin ob = new Register_Admin();
        ob.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseRegister_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChooseRegister_Admin().setVisible(true);
            }
        });
    }
