...
package Admin;
public class ChooseUpdate_Admin extends javax.swing.JFrame {
    public ChooseUpdate_Admin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("UPDATE AN ACCOUNT");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        setVisible(false);
        Update_Librarian ob = new Update_Librarian();
        ob.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        setVisible(false);
        Update_Borrower ob = new Update_Borrower();
        ob.setVisible(true);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        setVisible(false);
        Update_Admin ob = new Update_Admin();
        ob.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseUpdate_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChooseUpdate_Admin().setVisible(true);
            }
        });
    }
