 ...
 * @author Relox
 */
public class Register_Borrower_for_lib extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;
public String username;
    public String account_type = "Librarian";
    public Register_Borrower_for_lib() {
        super("Register"); //name 
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            String sql = "Insert into borrower (IdNumber, Name, PhoneNumber, Password, borrows, code) values (?, ?, ?, ?, 0, 0)"; // nilagyan ko lang ng borrow at code
...
//            pst.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_Borrower_for_lib.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_Borrower_for_lib().setVisible(true);
            }
        });
    }
