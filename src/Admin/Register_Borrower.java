 ...
 * @author Relox
 */
public class Register_Borrower extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;

    public Register_Borrower() {
        super("Register"); //name 
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("REGISTER A BORROWER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            int exist = 0;
            String sql2 = "select * from borrower where IdNumber=?";
            ...
            if(exist == 1) {
                ...
                String sql = "Insert into borrower (IdNumber, Name, PhoneNumber, Password, Borrows, code) values (?, ?, ?, ?, 0, 0)";
                ...
                JOptionPane.showMessageDialog(null, "New Borrower Account Created. ");
    ...
    private void php(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_php
          jTextField3.setText("");
    }//GEN-LAST:event_php
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_Borrower.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_Borrower().setVisible(true);
            }
        });
    }
